...
#define NTService_h
//==============================================================================
// used for what? [3/19/2009 bo.wang]
...
/* NTServices 所需要定义的宏                                                                     
/************************************************************************/
#define GENERAL_MESSAGE_ID 1
#define CAT_INFO     2
#define CAT_ERROR    3

class NTService 
{
	static BOOL				m_bInstance;			// only one NTService object per application

protected:
	//==============================================================================
	// data members
	//==============================================================================
	LPCTSTR					m_lpServiceName;		// Service Name 
	LPCTSTR					m_lpDisplayName;		// Service Display Name
	DWORD					m_dwCheckPoint;			
	DWORD					m_dwErr;				// Error  Code 
	...
	LPCTSTR			m_pszConfigFile;		// default: NULL
...
public:
	...
	//==============================================================================
	NTService(LPCTSTR ServiceName, LPCTSTR DisplayName = NULL);
	~NTService();
...
private:
	...
	NTService& operator=(const NTService &);
...
public:		
	...
	// and return control to the NTService class.
	//
	...
	// }
	//
	// Where "CMyService" is a NTService derived class.
	...
	//==============================================================================
	virtual BOOL ConfigService();

	//==============================================================================
	// Show help information
	//==============================================================================
	virtual BOOL HelpService();
	...
	//==============================================================================
	// Get config info from file or other
	//==============================================================================
	virtual BOOL GetConfigInfo();
...
protected:
	...
	//			NTService::RegisterApplicationLog(filename, EVENTLOG_ERROR_TYPE);
	//		}
	// This method will never be called on Win95.
	//==============================================================================
	virtual void RegisterApplicationLog(LPCTSTR lpszProposedMessageFile,
...
public:	
	...
	//==============================================================================
	virtual void ReportEvent(LPCTSTR	Message,
							 WORD		EventType		= EVENTLOG_ERROR_TYPE,
							 WORD		wEventCatagory	= CAT_ERROR,
...
//==============================================================================
// Retrieve the one and only NTService object
//==============================================================================
